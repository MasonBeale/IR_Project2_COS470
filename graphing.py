...
vals10 = get_vals("ft_bi_results\\result_bi_ft10_1.tsv")[:80]
vals20 = get_vals("ft_bi_results\\result_bi_ft20_1.tsv")[:80]
vals30 = get_vals("ft_bi_results\\result_bi_ft30_1.tsv")[:80]
vals40 = get_vals("ft_bi_results\\result_bi_ft40_1.tsv")[:80]
vals50 = get_vals("ft_bi_results\\result_bi_ft50_1.tsv")[:80]
...
plt.xlabel('Doc Rank')
plt.ylabel('P@5')
plt.title('P@5 Fine Tuned Bi-Encoders (topics_1)')
